    ...
    for pid in participant_ids:
        ...
        for session_idx in range(3):
            ...
            await create_session_manifest(
                ...
                signal_provider_version="1.0",
                policy_id=condition,
                policy_version="1.0",
                feature_processor_id="passthrough",
                feature_processor_version="1.0",
                state_estimator_id="rule_based",
                state_estimator_version="1.0",
                metric_processor_id="composite",
                metric_processor_version="1.0",
                curriculum_processor_id="fixed_level",
                curriculum_processor_version="1.0",
                safety_monitor_id="synthetic",
                safety_monitor_version="1.0",
                id_generator_id="deterministic",
                id_generator_version="1.0",
                clock_id="deterministic",
                clock_version="1.0",
